...
public class camex2 extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "descargaadc.xy.camex2");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", descargaadc.xy.camex2.class).invoke(this, new Object[] {null});
        else
...
boolean[] _i = null;
boolean _ii = false;
 //BA.debugLineNum = 479;BA.debugLine="Private Sub BoolsToList (Obj As Object) As List";
 //BA.debugLineNum = 480;BA.debugLine="Dim res As List";
_res = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 481;BA.debugLine="res.Initialize";
_res.Initialize();
 //BA.debugLineNum = 482;BA.debugLine="If Obj = Null Then Return res";
if (_obj== null) { 
if (true) return _res;};
 //BA.debugLineNum = 483;BA.debugLine="Dim i() As Boolean = Obj";
_i = (boolean[])(_obj);
 //BA.debugLineNum = 484;BA.debugLine="For Each ii As Boolean In i";
{
...
_ii = group5[index5];
 //BA.debugLineNum = 485;BA.debugLine="res.Add(ii)";
_res.Add((Object)(_ii));
 }
};
...
byte[] _i = null;
byte _ii = (byte)0;
 //BA.debugLineNum = 490;BA.debugLine="Private Sub BytesToList (Obj As Object) As List";
 //BA.debugLineNum = 491;BA.debugLine="Dim res As List";
_res = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 492;BA.debugLine="res.Initialize";
_res.Initialize();
 //BA.debugLineNum = 493;BA.debugLine="If Obj = Null Then Return res";
if (_obj== null) { 
if (true) return _res;};
 //BA.debugLineNum = 494;BA.debugLine="Dim i() As Byte = Obj";
_i = (byte[])(_obj);
 //BA.debugLineNum = 495;BA.debugLine="For Each ii As Byte In i";
{
...
for (; index5 < groupLen5;index5++){
_ii = group5[index5];
 //BA.debugLineNum = 496;BA.debugLine="res.Add(ii)";
_res.Add((Object)(_ii));
 }
};
 //BA.debugLineNum = 498;BA.debugLine="Return res";
if (true) return _res;
 //BA.debugLineNum = 499;BA.debugLine="End Sub";
return null;
}
public String  _camera_previewcapturecomplete(Object _captureresult) throws Exception{
 //BA.debugLineNum = 310;BA.debugLine="Private Sub Camera_PreviewCaptureComplete (Capture";
 //BA.debugLineNum = 311;BA.debugLine="FocusState = IntToConst(GetFromCaptureResult(Capt";
...
anywheresoftware.b4j.object.JavaObject _session = null;
 //BA.debugLineNum = 74;BA.debugLine="Private Sub CloseSession";
 //BA.debugLineNum = 75;BA.debugLine="Dim session As JavaObject = jcamera.GetFieldJO(\"c";
_session = new anywheresoftware.b4j.object.JavaObject();
_session = _jcamera.GetFieldJO("captureSession");
 //BA.debugLineNum = 76;BA.debugLine="If session.IsInitialized Then";
if (_session.IsInitialized()) { 
 //BA.debugLineNum = 77;BA.debugLine="session.RunMethod(\"stopRepeating\", Null)";
_session.RunMethod("stopRepeating",(Object[])(__c.Null));
 //BA.debugLineNum = 78;BA.debugLine="session.RunMethod(\"abortCaptures\", Null)";
_session.RunMethod("abortCaptures",(Object[])(__c.Null));
 //BA.debugLineNum = 79;BA.debugLine="jcamera.SetField(\"captureSession\", Null)";
...
public ResumableSub_CreateSurface(descargaadc.xy.camex2 parent) {
this.parent = parent;
}
descargaadc.xy.camex2 parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 146;BA.debugLine="If tv.IsInitialized Then tv.RemoveView";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 147;BA.debugLine="tv = Camera.CreateSurface";
parent._tv = parent._camera.CreateSurface(ba);
 //BA.debugLineNum = 148;BA.debugLine="mPanel.AddView(tv, 0, 0, mPanel.Width, mPanel.Hei";
parent._mpanel.AddView((android.view.View)(parent._tv.getObject()),(int) (0),(int) (0),parent._mpanel.getWidth(),parent._mpanel.getHeight());
 //BA.debugLineNum = 149;BA.debugLine="tv.SendToBack";
parent._tv.SendToBack();
 //BA.debugLineNum = 150;BA.debugLine="Wait For Camera_SurfaceReady";
...
anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _bmp = null;
 //BA.debugLineNum = 366;BA.debugLine="Public Sub DataToBitmap(Data() As Byte) As Bitmap";
 //BA.debugLineNum = 367;BA.debugLine="Dim in As InputStream";
_in = new anywheresoftware.b4a.objects.streams.File.InputStreamWrapper();
 //BA.debugLineNum = 368;BA.debugLine="in.InitializeFromBytesArray(Data, 0, Data.Length)";
_in.InitializeFromBytesArray(_data,(int) (0),_data.length);
 //BA.debugLineNum = 369;BA.debugLine="Dim bmp As Bitmap";
_bmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 370;BA.debugLine="bmp.Initialize2(in)";
_bmp.Initialize2((java.io.InputStream)(_in.getObject()));
 //BA.debugLineNum = 371;BA.debugLine="in.Close";
_in.Close();
 //BA.debugLineNum = 372;BA.debugLine="Return bmp";
if (true) return _bmp;
...
anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper _out = null;
 //BA.debugLineNum = 376;BA.debugLine="Public Sub DataToFile(Data() As Byte, Dir As Strin";
 //BA.debugLineNum = 377;BA.debugLine="Dim out As OutputStream = File.OpenOutput(Dir, Fi";
_out = new anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper();
_out = __c.File.OpenOutput(_dir,_filename,__c.False);
 //BA.debugLineNum = 378;BA.debugLine="out.WriteBytes(Data, 0, Data.Length)";
_out.WriteBytes(_data,(int) (0),_data.length);
 //BA.debugLineNum = 379;BA.debugLine="out.Close";
_out.Close();
...
float[] _f = null;
float _ff = 0f;
 //BA.debugLineNum = 513;BA.debugLine="Private Sub FloatsToList (Obj As Object) As List";
 //BA.debugLineNum = 514;BA.debugLine="Dim res As List";
_res = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 515;BA.debugLine="res.Initialize";
_res.Initialize();
 //BA.debugLineNum = 516;BA.debugLine="If Obj = Null Then Return res";
if (_obj== null) { 
if (true) return _res;};
 //BA.debugLineNum = 517;BA.debugLine="Dim f() As Float = Obj";
_f = (float[])(_obj);
 //BA.debugLineNum = 518;BA.debugLine="For Each ff As Float In f";
{
...
for (; index5 < groupLen5;index5++){
_ff = group5[index5];
 //BA.debugLineNum = 519;BA.debugLine="res.Add(ff)";
_res.Add((Object)(_ff));
 }
};
 //BA.debugLineNum = 521;BA.debugLine="Return res";
if (true) return _res;
...
public ResumableSub_FocusAndTakePicture(descargaadc.xy.camex2 parent,int _mytaskindex) {
this.parent = parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 273;BA.debugLine="Dim PreviewFocusMode As String = AF_MODE.Get(GetF";
_previewfocusmode = BA.ObjectToString(parent._af_mode.Get((int)(BA.ObjectToNumber(parent._getfromcapturerequest((Object)(parent._previewrequest.getObject()),"CONTROL_AF_MODE")))));
 //BA.debugLineNum = 274;BA.debugLine="Dim PreviewAEMode As String = AE_MODE.Get(GetFrom";
_previewaemode = BA.ObjectToString(parent._ae_mode.Get((int)(BA.ObjectToNumber(parent._getfromcapturerequest((Object)(parent._previewrequest.getObject()),"CONTROL_AE_MODE")))));
 //BA.debugLineNum = 275;BA.debugLine="If PreviewFocusMode = \"OFF\" Or PreviewFocusMode =";
if (true) break;
...
//C
this.state = 6;
 //BA.debugLineNum = 278;BA.debugLine="Dim PreviewBuilder As JavaObject = Camera.Create";
...
_previewbuilder = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(parent._camera.CreatePreviewBuilder()));
 //BA.debugLineNum = 279;BA.debugLine="PreviewSettingsMap.Put(\"CONTROL_AF_TRIGGER\", 1)";
parent._previewsettingsmap.Put((Object)("CONTROL_AF_TRIGGER"),(Object)(1));
 //BA.debugLineNum = 280;BA.debugLine="SetSettingsFromMap(PreviewBuilder, PreviewSettin";
parent._setsettingsfrommap(_previewbuilder,parent._previewsettingsmap);
 //BA.debugLineNum = 281;BA.debugLine="Camera.AddCaptureRequest(PreviewBuilder)";
parent._camera.AddCaptureRequest((Object)(_previewbuilder.getObject()));
 //BA.debugLineNum = 282;BA.debugLine="Wait For (WaitForFocusWithTimeout(5000)) Complet";
...
;
 //BA.debugLineNum = 283;BA.debugLine="If Success = False Then";
if (true) break;
...
this.state = 12;
;
 //BA.debugLineNum = 288;BA.debugLine="Wait For (TakePictureNow(MyTaskIndex)) Complete";
...
_data = (byte[]) result[0];
;
 //BA.debugLineNum = 289;BA.debugLine="Dim PreviewBuilder As JavaObject = Camera.Create";
_previewbuilder = new anywheresoftware.b4j.object.JavaObject();
_previewbuilder = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(parent._camera.CreatePreviewBuilder()));
 //BA.debugLineNum = 290;BA.debugLine="PreviewSettingsMap.Put(\"CONTROL_AF_TRIGGER\", 2)";
parent._previewsettingsmap.Put((Object)("CONTROL_AF_TRIGGER"),(Object)(2));
 //BA.debugLineNum = 291;BA.debugLine="SetSettingsFromMap(PreviewBuilder, PreviewSettin";
parent._setsettingsfrommap(_previewbuilder,parent._previewsettingsmap);
 //BA.debugLineNum = 292;BA.debugLine="Camera.AddCaptureRequest(PreviewBuilder)";
parent._camera.AddCaptureRequest((Object)(_previewbuilder.getObject()));
 //BA.debugLineNum = 293;BA.debugLine="PreviewSettingsMap.Remove(\"CONTROL_AF_TRIGGER\")";
parent._previewsettingsmap.Remove((Object)("CONTROL_AF_TRIGGER"));
 //BA.debugLineNum = 294;BA.debugLine="Wait For (PreviewBuilder) Camera_CaptureComplete";
...
;
 //BA.debugLineNum = 295;BA.debugLine="Return data";
if (true) {
...
this.state = -1;
;
 //BA.debugLineNum = 297;BA.debugLine="Wait For (TakePictureNow(MyTaskIndex)) Complete (";
parent.__c.WaitFor("complete", ba, this, parent._takepicturenow(_mytaskindex));
this.state = 16;
return;
case 16:
...
_data = (byte[]) result[0];
;
 //BA.debugLineNum = 298;BA.debugLine="Return data";
if (true) {
parent.__c.ReturnFromResumableSub(this,(Object)(_data));return;};
...
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper  _getactivearraysize() throws Exception{
 //BA.debugLineNum = 261;BA.debugLine="Public Sub getActiveArraySize As Rect";
 //BA.debugLineNum = 262;BA.debugLine="Return GetFromCameraCharacteristic(\"SENSOR_INFO_A";
...
public String  _getautoexposuremode() throws Exception{
 //BA.debugLineNum = 240;BA.debugLine="Public Sub getAutoExposureMode As String";
 //BA.debugLineNum = 241;BA.debugLine="Return IntToConst(GetFromCaptureRequest(PreviewRe";
...
public String  _getcontrolmode() throws Exception{
 //BA.debugLineNum = 244;BA.debugLine="Public Sub getControlMode As String";
 //BA.debugLineNum = 245;BA.debugLine="Return IntToConst(GetFromCaptureRequest(PreviewRe";
...
public String  _geteffectmode() throws Exception{
 //BA.debugLineNum = 196;BA.debugLine="Public Sub getEffectMode As String";
 //BA.debugLineNum = 197;BA.debugLine="Return IntToConst(GetFromCaptureRequest(PreviewRe";
...
public String  _getfocusmode() throws Exception{
 //BA.debugLineNum = 221;BA.debugLine="Public Sub getFocusMode As String";
 //BA.debugLineNum = 222;BA.debugLine="Return IntToConst(GetFromCaptureRequest(PreviewRe";
...
anywheresoftware.b4j.object.JavaObject _jo = null;
 //BA.debugLineNum = 387;BA.debugLine="Private Sub GetFromCameraCharacteristic (Field As";
 //BA.debugLineNum = 388;BA.debugLine="Dim jo As JavaObject = Camera.GetCameraCharacteri";
...
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_camera.GetCameraCharacteristics(_id)));
 //BA.debugLineNum = 389;BA.debugLine="Return jo.RunMethod(\"get\", Array(StaticCameraChar";
...
anywheresoftware.b4j.object.JavaObject _jo = null;
 //BA.debugLineNum = 397;BA.debugLine="Private Sub GetFromCaptureRequest(CaptureRequest A";
 //BA.debugLineNum = 398;BA.debugLine="Dim jo As JavaObject = CaptureRequest";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_capturerequest));
 //BA.debugLineNum = 399;BA.debugLine="Return jo.RunMethod(\"get\", Array(StaticCaptureReq";
...
anywheresoftware.b4j.object.JavaObject _jresult = null;
 //BA.debugLineNum = 392;BA.debugLine="Private Sub GetFromCaptureResult(CaptureResult As";
 //BA.debugLineNum = 393;BA.debugLine="Dim jresult As JavaObject = CaptureResult";
...
_jresult = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_captureresult));
 //BA.debugLineNum = 394;BA.debugLine="Return jresult.RunMethod(\"get\", Array(StaticCaptu";
...
int _front = 0;
int _orientation = 0;
 //BA.debugLineNum = 119;BA.debugLine="Private Sub GetHintOrientation As Int";
 //BA.debugLineNum = 120;BA.debugLine="Dim SensorOrientation As Int = GetFromCameraChara";
_sensororientation = (int)(BA.ObjectToNumber(_getfromcameracharacteristic("SENSOR_ORIENTATION")));
 //BA.debugLineNum = 121;BA.debugLine="Dim front As Int = -1";
_front = (int) (-1);
 //BA.debugLineNum = 122;BA.debugLine="If getIsFrontFacingCamera Then front = 1";
if (_getisfrontfacingcamera()) { 
_front = (int) (1);};
 //BA.debugLineNum = 123;BA.debugLine="Dim orientation As Int = (SensorOrientation + jca";
_orientation = (int) ((_sensororientation+(double)(BA.ObjectToNumber(_jcamera.GetField("lastKnownOrientation")))*_front+360)%360);
 //BA.debugLineNum = 124;BA.debugLine="Return orientation";
if (true) return _orientation;
 //BA.debugLineNum = 125;BA.debugLine="End Sub";
return 0;
}
public boolean  _getisfrontfacingcamera() throws Exception{
 //BA.debugLineNum = 383;BA.debugLine="Public Sub getIsFrontFacingCamera As Boolean";
 //BA.debugLineNum = 384;BA.debugLine="Return 0 = GetFromCameraCharacteristic(\"LENS_FACI";
...
public float  _getmaxdigitalzoom() throws Exception{
 //BA.debugLineNum = 230;BA.debugLine="Public Sub getMaxDigitalZoom As Float";
 //BA.debugLineNum = 231;BA.debugLine="Return GetFromCameraCharacteristic(\"SCALER_AVAILA";
...
anywheresoftware.b4j.object.JavaObject _jo = null;
 //BA.debugLineNum = 358;BA.debugLine="Public Sub GetPreviewBitmap(Width As Int, Height A";
 //BA.debugLineNum = 359;BA.debugLine="Dim mbmp As Bitmap";
_mbmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 360;BA.debugLine="mbmp.InitializeMutable(Width, Height)";
_mbmp.InitializeMutable(_width,_height);
 //BA.debugLineNum = 361;BA.debugLine="Dim jo As JavaObject = tv";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_tv.getObject()));
 //BA.debugLineNum = 362;BA.debugLine="Return jo.RunMethod(\"getBitmap\", Array(mbmp))";
...
public String  _getscenemode() throws Exception{
 //BA.debugLineNum = 188;BA.debugLine="Public Sub getSceneMode As String";
 //BA.debugLineNum = 189;BA.debugLine="Return IntToConst(GetFromCaptureRequest(PreviewRe";
...
public anywheresoftware.b4a.objects.collections.List  _getsupportedautoexposuremodes() throws Exception{
 //BA.debugLineNum = 235;BA.debugLine="Public Sub getSupportedAutoExposureModes As List";
 //BA.debugLineNum = 236;BA.debugLine="Return IntsToConstsList(GetFromCameraCharacterist";
...
public anywheresoftware.b4a.objects.collections.List  _getsupportedcapturesizes() throws Exception{
 //BA.debugLineNum = 172;BA.debugLine="Public Sub getSupportedCaptureSizes As List";
 //BA.debugLineNum = 173;BA.debugLine="Return Camera.GetSupportedCaptureSizes(id)";
...
public anywheresoftware.b4a.objects.collections.List  _getsupportedeffectmodes() throws Exception{
 //BA.debugLineNum = 200;BA.debugLine="Public Sub getSupportedEffectModes As List";
 //BA.debugLineNum = 201;BA.debugLine="Return IntsToConstsList(GetFromCameraCharacterist";
...
public anywheresoftware.b4a.objects.collections.List  _getsupportedfocusmodes() throws Exception{
 //BA.debugLineNum = 204;BA.debugLine="Public Sub getSupportedFocusModes As List";
 //BA.debugLineNum = 205;BA.debugLine="Return RemoveDuplicates(IntsToConstsList(GetFromC";
...
anywheresoftware.b4j.object.JavaObject _jo = null;
 //BA.debugLineNum = 84;BA.debugLine="Public Sub getSupportedHardwareLevel As String";
 //BA.debugLineNum = 85;BA.debugLine="Dim jo As JavaObject = Camera.GetCameraCharacteri";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_camera.GetCameraCharacteristics(BA.NumberToString(0))));
 //BA.debugLineNum = 86;BA.debugLine="Return IntToConst(jo.RunMethod(\"get\", Array(Stati";
...
public anywheresoftware.b4a.objects.collections.List  _getsupportedpreviewsizes() throws Exception{
 //BA.debugLineNum = 168;BA.debugLine="Public Sub getSupportedPreviewSizes As List";
 //BA.debugLineNum = 169;BA.debugLine="Return Camera.GetSupportedPreviewSizes(id)";
...
public anywheresoftware.b4a.objects.collections.List  _getsupportedscenemodes() throws Exception{
 //BA.debugLineNum = 180;BA.debugLine="Public Sub getSupportedSceneModes As List";
 //BA.debugLineNum = 181;BA.debugLine="Return RemoveDuplicates(IntsToConstsList(GetFromC";
...
public anywheresoftware.b4a.objects.collections.List  _getsupportedvideosizes() throws Exception{
 //BA.debugLineNum = 176;BA.debugLine="Public Sub getSupportedVideoSizes As List";
 //BA.debugLineNum = 177;BA.debugLine="Return Camera.GetSupportedVideoSizes(id)";
...
_previewsize.Initialize((int) (640),(int) (480));
 //BA.debugLineNum = 41;BA.debugLine="CaptureSize.Initialize(640, 480)";
_capturesize.Initialize((int) (640),(int) (480));
 //BA.debugLineNum = 43;BA.debugLine="StaticCaptureRequest.InitializeStatic(\"android.ha";
_staticcapturerequest.InitializeStatic("android.hardware.camera2.CaptureRequest");
 //BA.debugLineNum = 44;BA.debugLine="StaticCameraCharacteristics.InitializeStatic(\"and";
_staticcameracharacteristics.InitializeStatic("android.hardware.camera2.CameraCharacteristics");
 //BA.debugLineNum = 45;BA.debugLine="StaticCaptureResult.InitializeStatic(\"android.har";
_staticcaptureresult.InitializeStatic("android.hardware.camera2.CaptureResult");
 //BA.debugLineNum = 46;BA.debugLine="PreviewSettingsMap.Initialize";
_previewsettingsmap.Initialize();
 //BA.debugLineNum = 47;BA.debugLine="CaptureSettingMap.Initialize";
_capturesettingmap.Initialize();
 //BA.debugLineNum = 48;BA.debugLine="bothMaps = Array(PreviewSettingsMap, CaptureSetti";
...
int[] _f = null;
int _mode = 0;
 //BA.debugLineNum = 415;BA.debugLine="Private Sub IntsToConstsList (Ints As Object, Cons";
 //BA.debugLineNum = 416;BA.debugLine="Dim res As List";
_res = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 417;BA.debugLine="res.Initialize";
_res.Initialize();
 //BA.debugLineNum = 418;BA.debugLine="If Ints = Null Then Return res";
if (_ints== null) { 
if (true) return _res;};
 //BA.debugLineNum = 419;BA.debugLine="Dim f() As Int = Ints";
_f = (int[])(_ints);
 //BA.debugLineNum = 420;BA.debugLine="For Each mode As Int In f";
{
final int[] group5 = _f;
final int groupLen5 = group5.length
;int index5 = 0;
...
for (; index5 < groupLen5;index5++){
_mode = group5[index5];
 //BA.debugLineNum = 421;BA.debugLine="If mode >=0 And mode < Consts.Size Then";
if (_mode>=0 && _mode<_consts.getSize()) { 
 //BA.debugLineNum = 422;BA.debugLine="res.Add(Consts.Get(mode))";
...
int[] _i = null;
int _ii = 0;
 //BA.debugLineNum = 502;BA.debugLine="Private Sub IntsToList (Obj As Object) As List";
 //BA.debugLineNum = 503;BA.debugLine="Dim res As List";
_res = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 504;BA.debugLine="res.Initialize";
_res.Initialize();
 //BA.debugLineNum = 505;BA.debugLine="If Obj = Null Then Return res";
if (_obj== null) { 
if (true) return _res;};
 //BA.debugLineNum = 506;BA.debugLine="Dim i() As Int = Obj";
_i = (int[])(_obj);
 //BA.debugLineNum = 507;BA.debugLine="For Each ii As Int In i";
{
final int[] group5 = _i;
final int groupLen5 = group5.length
;int index5 = 0;
...
for (; index5 < groupLen5;index5++){
_ii = group5[index5];
 //BA.debugLineNum = 508;BA.debugLine="res.Add(ii)";
_res.Add((Object)(_ii));
 }
};
 //BA.debugLineNum = 510;BA.debugLine="Return res";
if (true) return _res;
...
int _i = 0;
 //BA.debugLineNum = 403;BA.debugLine="Private Sub IntToConst (Int1 As Object, Consts As";
 //BA.debugLineNum = 404;BA.debugLine="If Int1 = Null Then Return \"\"";
if (_int1== null) { 
if (true) return "";};
 //BA.debugLineNum = 405;BA.debugLine="Dim i As Int = Int1";
_i = (int)(BA.ObjectToNumber(_int1));
 //BA.debugLineNum = 406;BA.debugLine="If i >= 0 And i < Consts.Size Then";
if (_i>=0 && _i<_consts.getSize()) { 
 //BA.debugLineNum = 407;BA.debugLine="Return Consts.Get(i)";
...
Object[] _o = null;
Object _oo = null;
 //BA.debugLineNum = 468;BA.debugLine="Private Sub ObjectsToList(Obj As Object) As List";
 //BA.debugLineNum = 469;BA.debugLine="Dim res As List";
_res = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 470;BA.debugLine="res.Initialize";
_res.Initialize();
 //BA.debugLineNum = 471;BA.debugLine="If Obj = Null Then Return res";
if (_obj== null) { 
if (true) return _res;};
 //BA.debugLineNum = 472;BA.debugLine="Dim o() As Object = Obj";
_o = (Object[])(_obj);
 //BA.debugLineNum = 473;BA.debugLine="For Each oo As Object In o";
{
...
for (; index5 < groupLen5;index5++){
_oo = group5[index5];
 //BA.debugLineNum = 474;BA.debugLine="res.Add(oo)";
_res.Add(_oo);
 }
};
 //BA.debugLineNum = 476;BA.debugLine="Return res";
if (true) return _res;
...
public ResumableSub_OpenCamera(descargaadc.xy.camex2 parent,boolean _front) {
this.parent = parent;
this._front = _front;
}
descargaadc.xy.camex2 parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 54;BA.debugLine="TaskIndex = TaskIndex + 1";
parent._taskindex = (int) (parent._taskindex+1);
 //BA.debugLineNum = 55;BA.debugLine="If Camera.IsCameraOpen Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 56;BA.debugLine="Stop";
parent._stop();
 if (true) break;
...
this.state = 5;
;
 //BA.debugLineNum = 58;BA.debugLine="mFront = Front";
parent._mfront = _front;
 //BA.debugLineNum = 59;BA.debugLine="id = Camera.FindCameraId(mFront)";
parent._id = parent._camera.FindCameraId(parent._mfront);
 //BA.debugLineNum = 60;BA.debugLine="If id = \"\" Then";
if (true) break;
...
this.state = 9;
;
 //BA.debugLineNum = 64;BA.debugLine="Camera.OpenCamera(id)";
parent._camera.OpenCamera(parent._id);
 //BA.debugLineNum = 65;BA.debugLine="Wait For Camera_CameraState (Open As Boolean)";
...
;
 //BA.debugLineNum = 66;BA.debugLine="If Open = False Then";
if (true) break;
...
parent.__c.ReturnFromResumableSub(this,(Object)(0));return;};
 if (true) break;
;
 //BA.debugLineNum = 70;BA.debugLine="If PrintKeys Then PrintAllKeys(Camera.GetCameraCh";
...
this.state = -1;
;
 //BA.debugLineNum = 71;BA.debugLine="Return TaskIndex";
if (true) {
...
public ResumableSub_PrepareSurface(descargaadc.xy.camex2 parent,int _mytaskindex) {
this.parent = parent;
this._mytaskindex = _mytaskindex;
}
descargaadc.xy.camex2 parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 92;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return False";
if (true) break;
...
this.state = 7;
;
 //BA.debugLineNum = 93;BA.debugLine="CloseSession";
parent._closesession();
 //BA.debugLineNum = 94;BA.debugLine="Wait For (CreateSurface) Complete (Result As Bool";
...
;
 //BA.debugLineNum = 95;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return False";
if (true) break;
...
this.state = 13;
;
 //BA.debugLineNum = 96;BA.debugLine="Camera.StartSession(tv, PreviewSize, CaptureSize,";
parent._camera.StartSession((android.view.TextureView)(parent._tv.getObject()),parent._previewsize,parent._capturesize,(int) (256),(int) (0),parent.__c.False);
 //BA.debugLineNum = 97;BA.debugLine="Wait For Camera_SessionConfigured (Success As Boo";
...
_success = (Boolean) result[0];
;
 //BA.debugLineNum = 98;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return False";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 99;BA.debugLine="Return Success";
if (true) {
...
public ResumableSub_PrepareSurfaceForVideo(descargaadc.xy.camex2 parent,int _mytaskindex,String _dir,String _filename) {
this.parent = parent;
this._mytaskindex = _mytaskindex;
this._dir = _dir;
...
//C
this.state = 1;
 //BA.debugLineNum = 106;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return False";
if (true) break;
...
this.state = 7;
;
 //BA.debugLineNum = 107;BA.debugLine="CloseSession";
parent._closesession();
 //BA.debugLineNum = 108;BA.debugLine="Wait For (CreateSurface) Complete (Result As Bool";
parent.__c.WaitFor("complete", ba, this, parent._createsurface());
this.state = 19;
return;
case 19:
...
_result = (Boolean) result[0];
;
 //BA.debugLineNum = 109;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return False";
if (true) break;
...
this.state = 13;
;
 //BA.debugLineNum = 110;BA.debugLine="File.Delete(Dir, FileName)";
parent.__c.File.Delete(_dir,_filename);
 //BA.debugLineNum = 111;BA.debugLine="MediaRecorder = Camera.CreateMediaRecorder(Previe";
parent._mediarecorder = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(parent._camera.CreateMediaRecorder(parent._previewsize,_dir,_filename)));
 //BA.debugLineNum = 112;BA.debugLine="MediaRecorder.RunMethod(\"setOrientationHint\", Arr";
parent._mediarecorder.RunMethod("setOrientationHint",new Object[]{(Object)(parent._gethintorientation())});
 //BA.debugLineNum = 113;BA.debugLine="Camera.StartSession(tv, PreviewSize, CaptureSize,";
parent._camera.StartSession((android.view.TextureView)(parent._tv.getObject()),parent._previewsize,parent._capturesize,(int) (0),(int) (0),parent.__c.True);
 //BA.debugLineNum = 114;BA.debugLine="Wait For Camera_SessionConfigured (Success As Boo";
parent.__c.WaitFor("camera_sessionconfigured", ba, this, null);
this.state = 20;
return;
case 20:
...
_success = (Boolean) result[0];
;
 //BA.debugLineNum = 115;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return False";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 116;BA.debugLine="Return Success";
if (true) {
parent.__c.ReturnFromResumableSub(this,(Object)(_success));return;};
...
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_cameramap));
 //BA.debugLineNum = 449;BA.debugLine="Dim keys As List = jo.RunMethod(\"getKeys\", Null)";
...
_keys = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_jo.RunMethod("getKeys",(Object[])(__c.Null))));
 //BA.debugLineNum = 450;BA.debugLine="For Each k As JavaObject In keys";
...
_k = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(group4.Get(index4)));
 //BA.debugLineNum = 451;BA.debugLine="Dim value As Object = jo.RunMethod(\"get\", Array(";
_value = _jo.RunMethod("get",new Object[]{(Object)(_k.getObject())});
 //BA.debugLineNum = 452;BA.debugLine="If value = Null Then Continue";
if (_value== null) { 
if (true) continue;};
 //BA.debugLineNum = 453;BA.debugLine="Dim typ As String = GetType(value)";
_typ = __c.GetType(_value);
 //BA.debugLineNum = 454;BA.debugLine="If typ = \"[F\" Then";
if ((_typ).equals("[F")) { 
 //BA.debugLineNum = 455;BA.debugLine="value = FloatsToList(value)";
_value = (Object)(_floatstolist(_value).getObject());
 }else if((_typ).equals("[I")) { 
 //BA.debugLineNum = 457;BA.debugLine="value = IntsToList(value)";
_value = (Object)(_intstolist(_value).getObject());
 }else if((_typ).equals("[Z")) { 
 //BA.debugLineNum = 459;BA.debugLine="value = BoolsToList(value)";
_value = (Object)(_boolstolist(_value).getObject());
 }else if((_typ).equals("[B")) { 
 //BA.debugLineNum = 461;BA.debugLine="value = BytesToList(value)";
_value = (Object)(_bytestolist(_value).getObject());
 }else if(_typ.startsWith("[")) { 
 //BA.debugLineNum = 463;BA.debugLine="value = ObjectsToList(value)";
...
String _f = "";
 //BA.debugLineNum = 208;BA.debugLine="Private Sub RemoveDuplicates(Raw As List) As List";
 //BA.debugLineNum = 209;BA.debugLine="Dim unique As Map";
_unique = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 210;BA.debugLine="unique.Initialize";
_unique.Initialize();
 //BA.debugLineNum = 211;BA.debugLine="For Each f As String In Raw";
{
...
_f = BA.ObjectToString(group3.Get(index3));
 //BA.debugLineNum = 212;BA.debugLine="unique.Put(f, \"\")";
_unique.Put((Object)(_f),(Object)(""));
 }
};
 //BA.debugLineNum = 214;BA.debugLine="Raw.Clear";
_raw.Clear();
 //BA.debugLineNum = 215;BA.debugLine="For Each f As String In unique.Keys";
{
...
_f = BA.ObjectToString(group7.Get(index7));
 //BA.debugLineNum = 216;BA.debugLine="Raw.Add(f)";
_raw.Add((Object)(_f));
 }
};
 //BA.debugLineNum = 218;BA.debugLine="Return Raw";
if (true) return _raw;
 //BA.debugLineNum = 219;BA.debugLine="End Sub";
return null;
}
public String  _setautoexposuremode(String _mode) throws Exception{
 //BA.debugLineNum = 247;BA.debugLine="Public Sub setAutoExposureMode (Mode As String)";
 //BA.debugLineNum = 248;BA.debugLine="SetBothMaps(\"CONTROL_AE_MODE\", AE_MODE.IndexOf(Mo";
_setbothmaps("CONTROL_AE_MODE",(Object)(_ae_mode.IndexOf((Object)(_mode))));
 //BA.debugLineNum = 249;BA.debugLine="PreviewSettingsMap.Put(\"FLASH_MODE\", FLASH_MODE.I";
_previewsettingsmap.Put((Object)("FLASH_MODE"),(Object)(_flash_mode.IndexOf((Object)("OFF"))));
 //BA.debugLineNum = 250;BA.debugLine="If Mode = \"ON_ALWAYS_FLASH\" Then";
if ((_mode).equals("ON_ALWAYS_FLASH")) { 
 //BA.debugLineNum = 251;BA.debugLine="CaptureSettingMap.Put(\"FLASH_MODE\", FLASH_MODE.I";
...
anywheresoftware.b4a.objects.collections.Map _m = null;
 //BA.debugLineNum = 265;BA.debugLine="Private Sub SetBothMaps(Key As String, Value As Ob";
 //BA.debugLineNum = 266;BA.debugLine="For Each m As Map In bothMaps";
...
_m = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(group1.Get(index1)));
 //BA.debugLineNum = 267;BA.debugLine="m.Put(Key, Value)";
...
public String  _seteffectmode(String _mode) throws Exception{
 //BA.debugLineNum = 192;BA.debugLine="Public Sub setEffectMode(Mode As String)";
 //BA.debugLineNum = 193;BA.debugLine="SetBothMaps(\"CONTROL_EFFECT_MODE\", EFFECT_MODE.In";
...
public String  _setfocusmode(String _mode) throws Exception{
 //BA.debugLineNum = 225;BA.debugLine="Public Sub setFocusMode(mode As String)";
 //BA.debugLineNum = 226;BA.debugLine="SetBothMaps(\"CONTROL_AF_MODE\", AF_MODE.IndexOf(mo";
...
public String  _setpreviewcropregion(anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper _r) throws Exception{
 //BA.debugLineNum = 256;BA.debugLine="Public Sub setPreviewCropRegion(r As Rect)";
 //BA.debugLineNum = 257;BA.debugLine="PreviewSettingsMap.Put(\"SCALER_CROP_REGION\", r)";
...
public String  _setscenemode(String _mode) throws Exception{
 //BA.debugLineNum = 184;BA.debugLine="Public Sub setSceneMode(Mode As String)";
 //BA.debugLineNum = 185;BA.debugLine="SetBothMaps(\"CONTROL_SCENE_MODE\", SCENE_MODE.Inde";
...
String _key = "";
 //BA.debugLineNum = 431;BA.debugLine="Private Sub SetSettingsFromMap (Builder As JavaObj";
 //BA.debugLineNum = 432;BA.debugLine="For Each key As String In m.Keys";
{
...
_key = BA.ObjectToString(group1.Get(index1));
 //BA.debugLineNum = 433;BA.debugLine="Builder.RunMethod(\"set\", Array(StaticCaptureRequ";
...
anywheresoftware.b4j.object.JavaObject _previewbuilder = null;
 //BA.debugLineNum = 155;BA.debugLine="Public Sub StartPreview (MyTaskIndex As Int, Video";
 //BA.debugLineNum = 156;BA.debugLine="Dim PreviewBuilder As JavaObject";
_previewbuilder = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 157;BA.debugLine="If VideoRecording Then";
if (_videorecording) { 
 //BA.debugLineNum = 158;BA.debugLine="PreviewBuilder = Camera.CreateVideoRequestBuilde";
_previewbuilder = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_camera.CreateVideoRequestBuilder()));
 ...
 //BA.debugLineNum = 160;BA.debugLine="PreviewBuilder = Camera.CreatePreviewBuilder";
_previewbuilder = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_camera.CreatePreviewBuilder()));
 ...
 //BA.debugLineNum = 162;BA.debugLine="SetSettingsFromMap(PreviewBuilder, PreviewSetting";
_setsettingsfrommap(_previewbuilder,_previewsettingsmap);
 //BA.debugLineNum = 163;BA.debugLine="PreviewRequest = Camera.SetRepeatingRequest(Previ";
_previewrequest = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_camera.SetRepeatingRequest((Object)(_previewbuilder.getObject()))));
 //BA.debugLineNum = 164;BA.debugLine="If PrintKeys Then PrintAllKeys(PreviewRequest, \"P";
if (_printkeys) { 
...
public String  _startvideorecording(int _mytaskindex) throws Exception{
 //BA.debugLineNum = 128;BA.debugLine="Public Sub StartVideoRecording (MyTaskIndex As Int";
 //BA.debugLineNum = 129;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return";
if (_mytaskindex!=_taskindex) { 
if (true) return "";};
 //BA.debugLineNum = 130;BA.debugLine="MediaRecorder.RunMethod(\"start\", Null)";
_mediarecorder.RunMethod("start",(Object[])(__c.Null));
 //BA.debugLineNum = 131;BA.debugLine="RecordingVideo = True";
_recordingvideo = __c.True;
 //BA.debugLineNum = 132;BA.debugLine="End Sub";
return "";
}
public String  _stop() throws Exception{
 //BA.debugLineNum = 437;BA.debugLine="Public Sub Stop";
 //BA.debugLineNum = 438;BA.debugLine="RecordingVideo = False";
_recordingvideo = __c.False;
 //BA.debugLineNum = 439;BA.debugLine="Camera.Stop";
_camera.Stop();
 //BA.debugLineNum = 440;BA.debugLine="TaskIndex = TaskIndex + 1";
_taskindex = (int) (_taskindex+1);
 //BA.debugLineNum = 441;BA.debugLine="End Sub";
return "";
}
public String  _stopvideorecording(int _mytaskindex) throws Exception{
 //BA.debugLineNum = 135;BA.debugLine="Public Sub StopVideoRecording (MyTaskIndex As Int)";
 //BA.debugLineNum = 136;BA.debugLine="CloseSession";
_closesession();
 //BA.debugLineNum = 137;BA.debugLine="Try";
try { //BA.debugLineNum = 138;BA.debugLine="MediaRecorder.RunMethod(\"stop\", Null)";
...
public ResumableSub_TakePictureNow(descargaadc.xy.camex2 parent,int _mytaskindex) {
this.parent = parent;
this._mytaskindex = _mytaskindex;
}
descargaadc.xy.camex2 parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 318;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return False";
if (true) break;
...
this.state = 7;
;
 //BA.debugLineNum = 319;BA.debugLine="Camera.AbortCaptures";
parent._camera.AbortCaptures();
 //BA.debugLineNum = 320;BA.debugLine="Dim builder As JavaObject = Camera.CreateCaptureB";
...
_builder = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(parent._camera.CreateCaptureBuilder()));
 //BA.debugLineNum = 321;BA.debugLine="CaptureSettingMap.Put(\"JPEG_ORIENTATION\", GetHint";
parent._capturesettingmap.Put((Object)("JPEG_ORIENTATION"),(Object)(parent._gethintorientation()));
 //BA.debugLineNum = 322;BA.debugLine="SetSettingsFromMap(builder, CaptureSettingMap)";
parent._setsettingsfrommap(_builder,parent._capturesettingmap);
 //BA.debugLineNum = 323;BA.debugLine="Dim CaptureRequest As Object = Camera.AddCaptureR";
_capturerequest = parent._camera.AddCaptureRequest((Object)(_builder.getObject()));
 //BA.debugLineNum = 324;BA.debugLine="If PrintKeys Then PrintAllKeys(CaptureRequest, \"C";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 325;BA.debugLine="Wait For Camera_PictureTaken (Data() As Byte)";
...
_data = (byte[]) result[0];
;
 //BA.debugLineNum = 326;BA.debugLine="StartPreview(MyTaskIndex, False)";
parent._startpreview(_mytaskindex,parent.__c.False);
 //BA.debugLineNum = 327;BA.debugLine="Return Data";
if (true) {
parent.__c.ReturnFromResumableSub(this,(Object)(_data));return;};
...
public ResumableSub_TakePicturesNow(descargaadc.xy.camex2 parent,int _mytaskindex,int _numberofpictures) {
this.parent = parent;
this._mytaskindex = _mytaskindex;
...
//C
this.state = 1;
 //BA.debugLineNum = 337;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return False";
if (true) break;
...
this.state = 7;
;
 //BA.debugLineNum = 338;BA.debugLine="Camera.AbortCaptures";
parent._camera.AbortCaptures();
 //BA.debugLineNum = 339;BA.debugLine="Dim builder As JavaObject = Camera.CreateCaptureB";
_builder = new anywheresoftware.b4j.object.JavaObject();
_builder = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(parent._camera.CreateCaptureBuilder()));
 //BA.debugLineNum = 340;BA.debugLine="CaptureSettingMap.Put(\"JPEG_ORIENTATION\", GetHint";
parent._capturesettingmap.Put((Object)("JPEG_ORIENTATION"),(Object)(parent._gethintorientation()));
 //BA.debugLineNum = 341;BA.debugLine="SetSettingsFromMap(builder, CaptureSettingMap)";
parent._setsettingsfrommap(_builder,parent._capturesettingmap);
 //BA.debugLineNum = 342;BA.debugLine="Dim result As List";
_result = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 343;BA.debugLine="result.Initialize";
_result.Initialize();
 //BA.debugLineNum = 344;BA.debugLine="For i = 1 To NumberOfPictures";
if (true) break;
...
//C
this.state = 15;
 //BA.debugLineNum = 345;BA.debugLine="Camera.AddCaptureRequest(builder)";
parent._camera.AddCaptureRequest((Object)(_builder.getObject()));
 if (true) break;
if (true) break;
;
 //BA.debugLineNum = 347;BA.debugLine="For i = 1 To NumberOfPictures";
...
//C
this.state = 17;
 //BA.debugLineNum = 348;BA.debugLine="Wait For Camera_PictureTaken (Data() As Byte)";
parent.__c.WaitFor("camera_picturetaken", ba, this, null);
this.state = 18;
return;
case 18:
...
_data = (byte[]) result[0];
;
 //BA.debugLineNum = 349;BA.debugLine="result.Add(Data)";
...
this.state = -1;
;
 //BA.debugLineNum = 351;BA.debugLine="StartPreview(MyTaskIndex, False)";
parent._startpreview(_mytaskindex,parent.__c.False);
 //BA.debugLineNum = 352;BA.debugLine="Return result";
if (true) {
...
public ResumableSub_WaitForFocusWithTimeout(descargaadc.xy.camex2 parent,int _timeoutms) {
this.parent = parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 302;BA.debugLine="Dim start As Long = DateTime.Now";
_start = parent.__c.DateTime.getNow();
 //BA.debugLineNum = 303;BA.debugLine="Do Until FocusState = \"FOCUSED_LOCKED\" Or FocusSt";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 304;BA.debugLine="Sleep(50)";
...
this.state = 4;
;
 //BA.debugLineNum = 305;BA.debugLine="If DateTime.Now - start > TimeoutMs Then Return";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 307;BA.debugLine="Return FocusState = \"FOCUSED_LOCKED\"";
if (true) {
