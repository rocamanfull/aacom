...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "descargaadc.xy.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", descargaadc.xy.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public descargaadc.xy.b4xfloattextfield _searchfield = null;
...
_searchfield = new descargaadc.xy.b4xfloattextfield();
...
public ResumableSub_Show(descargaadc.xy.b4xsearchtemplate parent,descargaadc.xy.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
descargaadc.xy.b4xsearchtemplate parent;
