...
__c.LogImpl("926279939",("Page with this id already exists: "+__c.SmartStringFormatter("",(Object)(_idtolower))+"!"),0);
...
__c.LogImpl("926148885","#SupportedOrientations attribute must be set to landscape or portrait.",_xui.Color_Red);
 };
 };
 }
};
...
__c.LogImpl("926542084","Only top page can be closed",0);
...
__c.LogImpl("926542087","First page cannot be closed",0);
...
__c.LogImpl("927197443","Error: page id not found: "+_id,0);
 //BA.debugLineNum = 402;BA.debugLine="Log(\"Ids: \" & IdToB4XPage.Keys) 'ignore";
__c.LogImpl("927197444","Ids: "+BA.ObjectToString(_idtob4xpage._getkeys /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
__c.LogImpl("926083355","Call B4XPages.GetManager.LogEvents = True to enable logging B4XPages events.",0);
 };
...
__c.LogImpl("927787278","Too many parameters",0);
 break; }
}
;
...
__c.LogImpl("927852814","Too many parameters",0);
 break; }
}
;
