...
Private Sub B4XPage_Created (Root1 As B4XView)
	...
	Panel2.Color=Colors.RGB(238,232,170)
	
'	lblPage1Title.Text="Datos Carga 13"
'	Label3.Text="Datos Carga 14"
'	Label19.Text="Datos Carga 15"
'	'Label70.Text="Datos Carga16 "
'	B4XPages.SetTitle(Me, "Datos Cargas 13- 16")
	Label30.Text="Datos Carga 7"
	'lblPage1Title.Text="Datos Carga 1"
	Label3.Text="Datos Carga 8"
	Label19.Text="Datos Carga 9"
	lbl19.Text="Datos Carga 10"
	Label6.Text="Datos Carga 11"
	Label20.Text="Datos Carga 12"
	B4XPages.SetTitle(Me, "Datos Cargas 7 -12")
