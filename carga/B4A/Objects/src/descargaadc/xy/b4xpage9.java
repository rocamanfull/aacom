...
__c.LogImpl("878381087","carg1 es "+BA.ObjectToString(_mainpage._carg1 /*boolean*/ ),0);
 //BA.debugLineNum = 307;BA.debugLine="Log(\"carg2 es \"& MainPage.carg2)";
__c.LogImpl("878381088","carg2 es "+BA.ObjectToString(_mainpage._carg2 /*boolean*/ ),0);
 //BA.debugLineNum = 308;BA.debugLine="Log(\"bol1 es \"& MainPage.bol1)";
__c.LogImpl("878381089","bol1 es "+BA.ObjectToString(_mainpage._bol1 /*boolean*/ ),0);
 //BA.debugLineNum = 309;BA.debugLine="Log(\"bol2 es \"& MainPage.bol2)";
__c.LogImpl("878381090","bol2 es "+BA.ObjectToString(_mainpage._bol2 /*boolean*/ ),0);
 //BA.debugLineNum = 310;BA.debugLine="Log(\"super es \"& MainPage.super)";
__c.LogImpl("878381091","super es "+BA.ObjectToString(_mainpage._super /*boolean*/ ()),0);
