...
__c.LogImpl("240697935","carg1 es "+BA.ObjectToString(_mainpage._carg1 /*boolean*/ ),0);
 //BA.debugLineNum = 474;BA.debugLine="Log(\"carg2 es \"& MainPage.carg2)";
__c.LogImpl("240697936","carg2 es "+BA.ObjectToString(_mainpage._carg2 /*boolean*/ ),0);
 //BA.debugLineNum = 475;BA.debugLine="Log(\"bol1 es \"& MainPage.bol1)";
__c.LogImpl("240697937","bol1 es "+BA.ObjectToString(_mainpage._bol1 /*boolean*/ ),0);
 //BA.debugLineNum = 476;BA.debugLine="Log(\"bol2 es \"& MainPage.bol2)";
__c.LogImpl("240697938","bol2 es "+BA.ObjectToString(_mainpage._bol2 /*boolean*/ ),0);
 //BA.debugLineNum = 477;BA.debugLine="Log(\"super es \"& MainPage.super)";
__c.LogImpl("240697939","super es "+BA.ObjectToString(_mainpage._super /*boolean*/ ()),0);
