...
public class b4xfloattextfield extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "descargaadc.xy.b4xfloattextfield");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", descargaadc.xy.b4xfloattextfield.class).invoke(this, new Object[] {null});
        else
...
public descargaadc.xy.b4xfloattextfield _mnexttextfield = null;
...
_mnexttextfield = new descargaadc.xy.b4xfloattextfield();
...
__c.LogImpl("935717144","Multiline not supported with password mode.",0);
 };
...
public descargaadc.xy.b4xfloattextfield  _getnextfield() throws Exception{
...
if (_mnexttextfield.IsInitialized /*boolean*/ ()==__c.False || (_mnexttextfield).equals((descargaadc.xy.b4xfloattextfield)(this))) { 
...
public String  _setnextfield(descargaadc.xy.b4xfloattextfield _field) throws Exception{
...
if ((_field).equals((descargaadc.xy.b4xfloattextfield)(this)) == false) { 
...
_mnexttextfield = (descargaadc.xy.b4xfloattextfield)(_o);
...
public ResumableSub_SwitchFromPasswordToRegular(descargaadc.xy.b4xfloattextfield parent,boolean _toregular) {
this.parent = parent;
this._toregular = _toregular;
}
descargaadc.xy.b4xfloattextfield parent;
boolean _toregular;
String _text = "";
int _textcolor = 0;
...
if (_mnexttextfield.IsInitialized /*boolean*/ () && (_mnexttextfield).equals((descargaadc.xy.b4xfloattextfield)(this)) == false) { 
