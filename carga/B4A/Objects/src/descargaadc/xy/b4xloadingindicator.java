...
public class b4xloadingindicator extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "descargaadc.xy.b4xloadingindicator");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", descargaadc.xy.b4xloadingindicator.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_MainLoop(descargaadc.xy.b4xloadingindicator parent) {
this.parent = parent;
}
descargaadc.xy.b4xloadingindicator parent;
int _myindex = 0;
long _n = 0L;
float _progress = 0f;
