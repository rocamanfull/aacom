...
public class b4xbytesbuilder extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "descargaadc.xy.b4xbytesbuilder");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", descargaadc.xy.b4xbytesbuilder.class).invoke(this, new Object[] {null});
        else
...
public descargaadc.xy.b4xbytesbuilder  _append(byte[] _data) throws Exception{
...
public descargaadc.xy.b4xbytesbuilder  _append2(byte[] _data,int _startindex,int _length) throws Exception{
int _oldlength = 0;
...
if (true) return (descargaadc.xy.b4xbytesbuilder)(this);
...
if (_index>_mlength) { 
__c.LogImpl("952428802","Index too large",0);};
...
if (_index>_mlength) { 
__c.LogImpl("952494338","Index too large",0);};
