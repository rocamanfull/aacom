...
public class b4xcache extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "descargaadc.xy.b4xcache");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", descargaadc.xy.b4xcache.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public descargaadc.xy.b4xorderedmap _data = null;
...
_data = new descargaadc.xy.b4xorderedmap();
...
public descargaadc.xy.b4xcache._b4xcacheitem  _createb4xcacheitem(Object _value,String _key) throws Exception{
descargaadc.xy.b4xcache._b4xcacheitem _t1 = null;
...
_t1 = new descargaadc.xy.b4xcache._b4xcacheitem();
...
descargaadc.xy.b4xcache._b4xcacheitem _ci = null;
...
_ci = (descargaadc.xy.b4xcache._b4xcacheitem)(_data._get /*Object*/ ((Object)(_key)));
...
_ci = (descargaadc.xy.b4xcache._b4xcacheitem)(group3.Get(index3));
...
_data._remove /*String*/ ((Object)(((descargaadc.xy.b4xcache._b4xcacheitem)(_values.Get(_i))).Key /*String*/ ));
 }
};
 };
