...
'	Private plu1 As EditText
'	Private plu2 As EditText
'	Private plu3 As EditText
'	Private plu4 As EditText
	Private hora As EditText

	Private vapor As EditText
	Private conten As EditText
	Private cliente As EditText
	'Public CARG1 As Boolean
	'CARG1=False
...
'	B4XPages.AddPage("Page 1", Page1)
	...
	Panel2.Color=Colors.RGB(220,243,220)
	
	lblPage1Title.Text="Datos Carga 1"
	Label3.Text="Datos Carga 2"
	Label19.Text="Datos Carga 3"
	Label70.Text="Datos Carga 4"
	B4XPages.SetTitle(Me, "Datos Cargas 1- 4")
...
End Sub
Sub valid As  Boolean ''valida cajas de texto y combos se dejan afuera ver....
	...
	If a=True Or b= True Or c=True Or d=True Then
		Msgbox("Debe completar los datos pagina 1 ","ERROR")
		Return False
	End If
	Return True
...
Sub asoleado1_TextChanged (Old As String, New As String)'hacer 234
	...
	End If
End Sub
Sub heridas1_TextChanged (Old As String, New As String)'hacer 234
	If New.Length > 4 Then
		heridas1.Text = Old
	End If
End Sub
...
public Sub blanqueo2
	...
	calidadinterna1.SelectedIndex=0 'Text=""
	calidadinterna2.SelectedIndex=0 'Text=""
	calidadinterna3.SelectedIndex=0 'Text=""
	calidadinterna4.SelectedIndex=0 'Text=""
	sello1.Text=""
	sello2.Text=""
	sello4.Text=""
	sello3.Text=""
...
Private Sub Button2_Click
	...
	color3.Text="av"
	color4.Text="av"
	calidadinterna1.SelectedIndex=1
	calidadinterna2.SelectedIndex=2
	calidadinterna3.SelectedIndex=1
...
'Copiar
'Editar
'Sub FiltrarTexto(Edit As EditText, NewText As String)
'	Dim limpio As String = NewText.Replace(";", "")
'    
'	If limpio.Length > 4 Then
'		limpio = limpio.SubString2(0, 4)
'	End If
'
'	If Edit.Text <> limpio Then
'		Edit.Text = limpio
'		Edit.SelectionStart = Edit.Text.Length
'	End If
'End Sub
'Y en los eventos TextChanged:
'b4a
'Copiar
'Editar
'Sub EditText1_TextChanged (Old As String, New As String)
'	FiltrarTexto(EditText1, New)
'End Sub
'
'Sub EditText2_TextChanged (Old As String, New As String)
'	FiltrarTexto(EditText2, New)
'End Sub
