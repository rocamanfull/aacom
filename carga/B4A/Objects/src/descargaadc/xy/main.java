...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "descargaadc.xy", "descargaadc.xy.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "descargaadc.xy", "descargaadc.xy.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "descargaadc.xy.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._b4xpages._delegate /*descargaadc.xy.b4xpagesdelegator*/ ._activity_actionbarhomeclick /*String*/ ();
...
descargaadc.xy.b4xpagesmanager _pm = null;
 //BA.debugLineNum = 26;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
 //BA.debugLineNum = 27;BA.debugLine="Dim pm As B4XPagesManager";
_pm = new descargaadc.xy.b4xpagesmanager();
...
if (true) return mostCurrent._b4xpages._delegate /*descargaadc.xy.b4xpagesdelegator*/ ._activity_keypress /*boolean*/ (_keycode);
 //BA.debugLineNum = 42;BA.debugLine="End Sub";
return false;
}
public static String  _activity_pause(boolean _userclosed) throws Exception{
 //BA.debugLineNum = 48;BA.debugLine="Sub Activity_Pause (UserClosed As Boolean)";
 //BA.debugLineNum = 54;BA.debugLine="B4XPages.Delegate.Activity_Pause";
mostCurrent._b4xpages._delegate /*descargaadc.xy.b4xpagesdelegator*/ ._activity_pause /*String*/ ();
 //BA.debugLineNum = 55;BA.debugLine="End Sub";
return "";
}
public static String  _activity_permissionresult(String _permission,boolean _result) throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Sub Activity_PermissionResult (Permission As Strin";
 //BA.debugLineNum = 58;BA.debugLine="B4XPages.Delegate.Activity_PermissionResult(Permi";
mostCurrent._b4xpages._delegate /*descargaadc.xy.b4xpagesdelegator*/ ._activity_permissionresult /*String*/ (_permission,_result);
...
mostCurrent._b4xpages._delegate /*descargaadc.xy.b4xpagesdelegator*/ ._activity_resume /*String*/ ();
 //BA.debugLineNum = 46;BA.debugLine="End Sub";
return "";
}
public static String  _create_menu(Object _menu) throws Exception{
 //BA.debugLineNum = 61;BA.debugLine="Sub Create_Menu (Menu As Object)";
 //BA.debugLineNum = 62;BA.debugLine="B4XPages.Delegate.Create_Menu(Menu)";
mostCurrent._b4xpages._delegate /*descargaadc.xy.b4xpagesdelegator*/ ._create_menu /*String*/ (_menu);
